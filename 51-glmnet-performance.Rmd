...
#glmnet_pred_helper<-function(object, newdata, ...){
#  predict(object, newx=as.matrix(newdata), type='response', ...)1. The confusion matrix reflects the distribution of the data
...
glmnet_vip <- plot_variable_importance(glmnet_final_fit, assessment_data=test_data, mdl_name = 'glmnet',
                                       positive_class='site',
                                       pred_wrap=NULL,
                                       nothing=glmnet_final_fit$fit$fit$spec$args$penalty)
```
