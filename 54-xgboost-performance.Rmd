...
xgb_pred_helper<-function(object, newdata, ...){
  predict(object, data.matrix(newdata), ...)
}

xgb_vip <- plot_variable_importance(xgb_final_fit, newdata=train_data, mdl_name = 'xgb', positive_class='site',
                                   pred_wrapper = xgb_pred_helper)
```
