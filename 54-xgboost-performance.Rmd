...
**Make sure you run notebooks 10, 40, and the 43-xgboost-modeling notebook before attempting to run this notebook**
...
pacman::p_load(xgboost,recipes, parsnip)
```
...
best_xgb_fold_metrics <- calculate_best_performance_metrics(xgb_fold_metrics, xgb_best_params)
```
