...
pacman::p_load(glmnet, tictoc, vip, tidytext, randomForest)
```
...
rf_vip %>%
  ...
  labs(title='Scaled coefficient magnitudes of glmnet',
       subtitle=str_c('Penalty:', format(pull_workflow_fit(rf_final_fit)$spec$args$min_n,
                                         digits=5, nsmall=2, scientific=TRUE),
                      'Mixture:', format(pull_workflow_fit(rf_final_fit)$spec$args$trees[[2]],
                                         digits=5, nsmall=3),
                      sep=' '),
