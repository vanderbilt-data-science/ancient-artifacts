...
Here I removed all data points greater than 4.0 mm within the variables f_length, f_thickness, f_width, e_length, e_thickness, e_width. This reduces the dataset to only microdebitage.

```{r}
filter(ASData, f_width < 4.0, f_thickness < 4.0, f_length < 4.0, e_length < 4.0, e_thickness < 4.0, e_width < 4.0)
```
