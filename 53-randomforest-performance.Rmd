...
rf_pred_helper<-function(object, newdata, ...){
  predict(object, data=newdata, ...)$predictions #help from https://koalaverse.github.io/vip/articles/vip.html
}

rf_vip <- plot_variable_importance(rf_final_fit, newdata=train_data, mdl_name = 'rf', positive_class='exp',
                                   pred_wrapper = rf_pred_helper)
```
