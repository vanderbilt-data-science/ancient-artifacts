...
extract_targets <- function(agree_df, ref_cls, agree_thresh=0.99) {
  ...
  #ref_cls: the target class to be identified (e.g., microdebitage)
  #agree_thresh: if models have disagreements, all values >= this value will be considered to be the target if the target was predicted
  #             (i.e. majority-like voting)
